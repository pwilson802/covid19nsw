...
################### REMOVING THIS AS NSW DATA IS NO LONGER RELEASING TESTING RESULTS #######################
...
# # test_csv_file = "https://data.nsw.gov.au/data/dataset/60616720-3c60-4c52-b499-751f31e3b132/resource/945c6204-272a-4cad-8e33-dde791f5059a/download/covid-19-tests-by-date-and-postcode-local-health-district-and-local-government-area.csv"
...
suburbs = [x.split(',') for x in [postcode_dict[x]['suburbs'] for x in postcode_dict.keys() if x != 'all_nsw']]
...
for suburb in all_suburbs:
    ...
    for postcode in [x for x in postcode_dict.keys() if x != 'all_nsw']:
