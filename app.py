    ...
    if request.method == 'POST':
        ...
        if postcode.lower() not in validation_list:
            ...
            if len(all_options) == 0:
                ...
                other_options = 'yes'
            return render_template('postcode_error.html', postcode = postcode.title(), other_options = other_options, all_options = all_options, validation_set = all_postcode_suburb_list)
        ...
        if days == 'seven':
            ...
            return render_template("postcode.html",postcode = postcode, data = postcode_data, history=postcode_history[postcode],days_set = 'seven', close = close_postcode_data, validation_set = all_postcode_suburb_list)
        elif days == 'fourteen':
            ...
            return render_template("postcode.html",postcode = postcode, data = postcode_data, history=postcode_history[postcode],days_set = 'fourteen', close = close_postcode_data, validation_set = all_postcode_suburb_list )
        else:
