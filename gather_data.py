...
csv_cases = "https://data.nsw.gov.au/data/dataset/aefcde60-3b0c-4bc0-9af1-6fe652944ec2/resource/21304414-1ff1-4243-a5d2-f52778048b29/download/confirmed_cases_table1_location.csv"
...
csv_tests = "https://data.nsw.gov.au/data/dataset/60616720-3c60-4c52-b499-751f31e3b132/resource/fb95de01-ad82-4716-ab9a-e15cf2c78556/download/pcr_testing_table1_location_agg.csv"
...
for postcode in cases_data.keys():
    ...
    cases_data[postcode]['one_day']['cases'] = get_cases_back(postcode, days=1)
    cases_data[postcode]['one_day']['tests'] = get_tests_back(postcode, days=1)
    # cases_data[postcode]['one_day']['source'] = get_sources_back(postcode, days=1)
    # sleep(0.5)
...
high_level_data = {x: {'active_cases': cases_data[x]['cases_active'],
                       ...
                       'one_day': cases_data[x]['one_day']['cases']
                       } for x in cases_data}
